...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sangnguyen-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sangorg"
  #   chef.validation_client_name = "sangorg-validator"
  #   chef.validation_key_path = ".chef/sangorg-validator.pem"
  # end
end
