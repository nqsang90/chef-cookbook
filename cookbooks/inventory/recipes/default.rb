...
solr_mca = do_search('solr-mca', 'default', 'solr_mca')
host_solr_mca = solr_mca['ipaddress']
...
if (port_installment == '' || host_solr_mca == '')
	return
end
...
remote_file "#{mod_dir}/#{package}" do
	...
	checksum node['inventory']['checksum']
end
