...
def load_current_resource
  @current_resource = Chef::Resource::McaStructure.new(@new_resource.name)
...
def create_dir_struture
	...
	execute "make-#{artifact_id}.sh-executable" do
		cwd "#{app_dir}/bin/#{artifact_id}.sh"
		command "chmod a+x #{artifact_id}.sh"
	end
end
